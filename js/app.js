...
new Hiking("tent1","https://www.rei.com/dam/01-big-agnes-copper-spur-hv-ul4_badge3.jpg",ulTent1,649.95);
new Hiking("tent2", "https://www.rei.com/dam/02-nemo-dagger-2.jpg",ulTent2,449.95);
new Hiking("tent3", "https://www.rei.com/dam/06-msr-hubba-tour-2-1.jpg",ulTent3,556.95);
new Hiking( "boot1", "https://www.rei.com/dam/830165_011516_56340_backpacking_boot.jpg",ulboot1,128.55);
new Hiking("boot2", "https://m.media-amazon.com/images/I/61HVHhtrpTL._AC_UY500_.jpg",ulboot2,80.55);
new Hiking("boot3", "https://www.rei.com/dam/887859_032316_36740_hiking_shoe.jpg",ulboot3,99.65);
...
new Yoga( "yoga1", "https://sps24.eu/eng_pm_Yunmai-YMYG-T603-yoga-mat-pink-49493_1.jpg",ulYoga1,43.55);
new Yoga("yoga2", "https://sps24.eu/eng_pl_Yunmai-yoga-cube-blue-49491_2.jpg",ulYoga2,42.55);
new Yoga("yoga3", "https://cdn.shopify.com/s/files/1/1728/2157/products/05-63388_ACUPRESSURE-MAT-PILLOW_B_large.jpg?v=1621641485",ulYoga3,14.65);
...
function renderYoga() {
    ...
    let lies1 = ['Free and fast delivery    :  14 days for easy returns', 'Safe shopping   :   This product is not available in a stationary store', `Price: $ ${Yoga.allItems[0].price}`];

    let lies2 = ['Yunmai yoga cube blue Non-slip surface to ensure stability, with beveled edges for easy gripping. Whether under your hands, feet, or even your seat.', 'Ensure proper alignment during poses', `Price:$ ${Yoga.allItems[1].price}`];

    let lies3 = ['Self-guided 65 cm stability ball Do moves like sit-up twists, kick-back lunges and back extensions to enhance your core.', 'Easy-to-follow visuals for best resultsDiscover how much fun workouts can be with our Self-Guided Stability Ball.', `Price:$ ${Yoga.allItems[2].price}`];
...
new Gym("gym1","https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXXhPiWCK6wCehDxYAzzNAkRjC0OoJtBb3zA&usqp=CAU",ulGym1,800.95);
new Gym("gym2", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_MqaReTbMBcLac8cIQdPGuFpIlPIjNOr38A&usqp=CAU",ulGym2,42.55);
new Gym("gym3", "https://m.media-amazon.com/images/I/61ppEDBqssS._SL1500_.jpg",ulGym3,140.65);
...
function renderGym() {
    ...
    let lies1 = ['About this item :Treadmill dimensions – 50" L x 24" W x 49.2" H | Folded dimensions – 25.2” L x 24” W x', 'Design type:The compact treadmill for small spaces has LCD display w/ touch button controls', `Price:$ ${Gym.allItems[0].price}`];

    let lies2 = ['Realistic gym weights set - weight lifting equipment isolated on white background.', 'Heavy black barbells, light dumbbell and cast iron kettlebell, vector illustration.', `Price:$ ${Gym.allItems[1].price}`];

    let lies3 = ['Packaged weight: 30 lbs', ' About this item : Push up bar /warntee 6 monthes', `Price:$ ${Gym.allItems[2].price}`];
...
new Kendo("Kendo1","https://cdn.shopify.com/s/files/1/0104/6668/9105/products/WST_HL_97_CF_01_1200x.jpg?v=1584510036",ulKendo1,37.05);
new Kendo("Kendo2", "https://m.media-amazon.com/images/I/61Cqlj84RDL._AC_SL1000_.jpg",ulKendo2,77.95);
new Kendo("Kendo3", "https://www.ninecircles.co.uk/images/thumbnails/550/550/detailed/129210/KG-1-N-Kendogi-Model-Front_udh7-x1.jpg?t=1617804128",ulKendo3,44.65);
...
function renderKendo() {
    ...
    let lies1 = ['About this item  :Cutting-edge youth safety helmet for biking, skating, and more', 'Fits head sizes 22 to 23.5 inches :   Ergonomic interior padding is comfortable and secure', `Price:$ ${Kendo.allItems[0].price}`];

    let lies2 = ['About this item  : Snake Eye Tactical Ninja Sword and Kunai/Throwing Knife Set with Sheath', 'DURABLE BLACK COATED DESIGN BLADE  can be used both for recreational use and sharp enough to use in the kitchen', `Price:$ ${Kendo.allItems[1].price}`];

    let lies3 = ['Japanese set: Traditional Japanese Samurai Kimono Set Kendo Gi + Hakama Pants + Haori Jacket', ' Delivery: Estimated between Thu. Aug. 19 and Thu. Sep. 2', `Price:$ ${Kendo.allItems[2].price}`];
    ...
    function handleButton(event) {
        ...
        for (let i = 0; i < Hiking.allItems.length; i++) {
            ...
            if (elementId===`ul${event.target.id}`) {
                ...
                selectedProducts.push(Hiking.allItems[i])
...
Yoga.prototype.renderButtonYoga = function () {
    ...
    function handleButtonYoga(event) {
        ...
        for (let i = 0; i < Yoga.allItems.length; i++) {
            ...
            if (elementId===`ul${event.target.id}`) {
                ...
                selectedProducts.push(Yoga.allItems[i])
    ...
    function handleButtonGym(event) {
        ...
        for (let i = 0; i < Gym.allItems.length; i++) {
            ...
            if (elementId===`ul${event.target.id}`) {
                ...
                selectedProducts.push(Gym.allItems[i])
    ...
    for (let i = 0; i < Kendo.allItems.length; i++) {
        ...
        if (elementId===`ul${event.target.id}`.toLowerCase()) {
            ...
            selectedProducts.push(Kendo.allItems[i])
